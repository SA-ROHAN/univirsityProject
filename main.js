...
const closelist = document.querySelector('.card-list');
...
const updateTotals = () => {
    ...
    document.querySelectorAll('.item').forEach(item => {
        ...
        const priceText = item.querySelector('.item-total').textContent.replace('$', '');
...
const qualityValue = cartItem('.quantity-value');
...
plusBtn.addEventListener('click', (e) => {
    ...
    e.preventDefault();
    quantity++;
    qualityValue.textContent = quantity;
